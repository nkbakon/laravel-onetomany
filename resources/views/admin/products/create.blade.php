            ...
            <div class="p-6 text-gray-900">
                ...
                <form method="POST" action="{{ route('products.store') }}">
                    ...
                    <div>
                        ...
                        <select name="category_id" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" required>
                            <option value="" selected disabled>Selec category from here</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="price" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"placeholder="price" required>                    
                    </div>
                    <br>
